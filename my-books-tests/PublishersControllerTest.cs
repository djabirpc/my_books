...
namespace my_books_tests
{
    public class PublishersControllerTest
    {
        ...
        [Test,Order(1)]
        public void HTTPGET_GetAllPublishers_WithSertByPageNumber_ReturnOK_Test()
        {
        ...
        {
            IActionResult actionResult = publishersController.GetPublisherById(33);
        ...
        [Test, Order(5)]
        public void HTTPPOST_AddPublisher_ReturnBasRequest_Test()
        {
            var newPublisherVM = new PublisherVM()
            {
                Name = "99New Publisher"
            };
            IActionResult actionResult = publishersController.AddPublisher(newPublisherVM);
